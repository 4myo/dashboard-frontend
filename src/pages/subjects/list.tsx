...
const SubjectsList = () => {
    ...
    const departmentFilters = selectDepartment === 'all' ? [] : [{field: 'department', operator: 'eq'as const, value: selectDepartment}];
            ...
            <div className="intro-row">
                ...
                <div className="actions-row">
                    ...
                    <div className="flex gap-2 w-full sm:w-auto">
                        <Select value={selectDepartment} onValueChange={(e)=>setSelectDepartment(e)}
                        >
                            <SelectTrigger>
